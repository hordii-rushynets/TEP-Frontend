  ...
  return (
    <Container>
      ...
      <div className={"grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 my-[50px]"}>
        <SimpleCard source={PrivateLabelsImage} title={staticData.company.cooperation.text1} url={`${CompanyUrl.getCooperation()}/private-labels`}/>
        <SimpleCard source={WhilesaleImage} title={staticData.company.cooperation.text2} url={`${CompanyUrl.getCooperation()}/wholesale`}/>
      </div>
      <Conditions />
    </Container>
  );
